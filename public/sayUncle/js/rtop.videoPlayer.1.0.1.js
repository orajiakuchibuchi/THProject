...
(function(jQuery, window, document, undefined) {
    ...
    vid.prototype.addPlayPauseBtn = function() {
        var _self = this;
        _self._element.find('.vidControls').addClass('hasPP').prepend('<div id="playPause" class="controlBtn"><span class="' + (_self._settings.fontAwesomeControlIcons ? 'FAIcon' : 'localAsset') + '">' + ( _self._settings.fontAwesomeControlIcons ? '<i class="fas fa-pause"></i>' : '') + '</span></div>');
    }
    ...
    vid.prototype.play = function() {
        ...
        if (_self._settings.fontAwesomeControlIcons) {
            _self._playerWrapper.find('#playPause').html('<span class="FAIcon"><i class="fas fa-pause"></i></span>');
        } else {
    ...
    vid.prototype.pause = function() {
        ...
        if (_self._settings.fontAwesomeControlIcons) {
            _self._playerWrapper.find('#playPause').html('<span class="FAIcon"><i class="fas fa-play"></i></span>');
        } else {
