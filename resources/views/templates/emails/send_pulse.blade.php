                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px; color: red;">
                                           Hello and thanks for signing up with vicomma.com.
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:10px; color: red;">
                                            Vicomma is the only platform of its kind where a community of creatives and vendors meet to earn big.
                                        </p>
										 <p style="line-height: 24px; margin-bottom:20px; color: red;">
                                            Whether you’re a seller, musician, comedian, fashionista, influencer, or whatever; vicomma is for you. 
                                        </p>
