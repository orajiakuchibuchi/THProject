                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:40px; color:black;">
                                            Thanks for requesting to vote for {{ ucwords($contestant_name) }}. This will help boost the chances of your choice contestant to become one of Uncle’s relatives. Simply click on the link below to verify your vote for {{ ucwords($contestant_name) }}. Don’t forget to tune into Say Uncle. See you soon.
                                             <br><br>
                                             {{$url}}
                                        </p>
