                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:40px; color:black;">
                                            Please use the link below to <b>Upload Videos</b> for your Say Uncle audition submission. Click on this link so we can see what you’ve got!
                                            <br><br>
                                             {{$url}}
                                        </p>
                                        <br>
                                        ...
                                        <p style="line-height: 24px; margin-bottom:40px; color:black;">
                                             Below is your personal Say Uncle Referral Link to share with your friends and family. This link will let friends and family vote for you and help you get more points to get closer to becoming one of the relatives! So, share with everyone you know.
                                             <br><br>
                                             {{$referal_url}}
                                        </p>
