...
@section('content')
            ...
            <div class="container">
                <div class="row alignCenter">
                    <div class="col-md-7">
                        ...
                        <h2 class="heading cover_heading">NOW IS THE BEST TIME TO BE AN INFLUENCER</h2>
                        <!--<p class="cover_sub">Discover New Ways To Become An Influencer Online</p>-->
                        ...
                        <ul class="hero_list">
                            <li>Discover new ways to become an influencer online</li>
                            <li>Start your journey to becoming an internet celebrity</li>
                        </ul>
                        <button type="button" class="btn btn-primary btn-lg call_action_btn col-md-3 col-lg-2" data-toggle="modal"
                                data-target="#ebookModal">Get the ebook
                        </button>
                    </div>
                    <div class="col-md-5">
        ...
        <section class="sectionPB list_section left_art">
            <div class="container">
                <div class="row alignCenter">
                    ...
                    <div class="col-md-7">
                        <ul class="tick_list">
                            <li><i class="fas fa-check icon"></i>Have you ever thought of becoming an internet celebrity?
                            </li>
                            <li><i class="fas fa-check icon"></i>This seems impossible to you considering the height of the
                                noise on the internet.
                            </li>
                            <li><i class="fas fa-check icon"></i>You wake up every night thinking of how to convert your
                                large number of followers into cash
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="sectionPT sectionPB gr_section">
        <div class="container bg_gradient p40">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="heading section_title">VICOMMA BRINGS TO YOU THE NEW DRIVEWAY FOR PROFITING
                        INFLUENCERS</h1>
                    <ul class="tick_list">
                        <li><i class="fas fa-check icon"></i>Everyday young people are thinking of maximizing the
                            internet as an influencer and many more are looking for the best platform to make more money
                            as an influencer
                        </li>
                        <li><i class="fas fa-check icon"></i>We bring to you Vicomma; the new drive way for every
                            influencers
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 right_sec ">
                    ...
                    <button class="btn-primary btn btn-lg rg_btn" data-toggle="modal"
        ...
        <div class="container">
            <div class="row alignCenter">
                <div class="col-md-7">
                    ...
                    <ul class="tick_list">
                        <li><i class="fas fa-check icon"></i>Gives you an edge to become a profitable influencer</li>
                        <li><i class="fas fa-check icon"></i>This book opens your mind up to new opportunities that
                            Vicomma (a maxflix company) presents every influencer
                        </li>
                    </ul>
                </div>
                <div class="col-md-5">
                ...
                <div class="col-md-12">
                    <div class="row author_item">
                        ...
                        <div class="col-md-9 col-sm-6 col-lg-8">
                            ...
                            <p>B.O.E. Odeniyi is an experienced engineer and entrepreneur. For nearly 20 years, Mr.
                                Odeniyi has been involved in several industries from commercial to federal projects as a
                                contractor as well as a consultant. All the while, he has also been operating his own
                                company, EMG LLC./Dotweinc Ventures Limited. </p>


                            <p> Mr. Odeniyi has dedicated years to entrepreneurial endeavors and in the process has
                                developed businesses in the technology, transportation, housing, smart devices, and
                                entertainment industries both in the United States and Africa. He is a force to be
                                reckoned with.</p>

                            <p>His latest endeavor, Vicomma, part of the Maxflix Companies, is on target to be a game
                                changer. To learn more about Mr. Odeniyi and his endeavors, visit the company page at
                                www.myendpoint.com.</p>

                            <p>“ Less talk, more action.” – B.O.E. Odeniyi</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="row author_item">
                        ...
                        <div class="col-md-9">
                            ...
                            <p>Deriving his passion from his encounter with the computer system when he was 7years
                                old,</p>

                            <p>Justus Nwosu is a Tech Entrepreneur focused in Digital Development (web & app), Strategic
                                Digital Marketing.</p>

                            <p>He is the founder of Hurricane Digital Agency and Joooka, a Tech Business Coach, He has
                                helped developed and managed multiple Internet businesses across Nigeria.</p>

                            <p>He believes he is a super human in service and he also believes in making simple things
                                great.</p>
                        </div>
                    </div>
                </div>
