        ...
        <div class="row">
    		<div class="col-md-10 offset-md-1">
		        <div class="box box-info">
		        	...
		        	<!-- /.box-header -->
			            <!-- form start -->
					<form class="form-horizontal" action="{{route('console.event.save')}}" method="post" enctype= "multipart/form-data">
						@csrf
						...
						<div class="box-body col-sm-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									<textarea class="form-control" name="description" id="description" placeholder="Description" cols="5"></textarea>
								</div>
							</div>
